...
//将忘记密码模态框显示出来
        this.showHtml=function(){
            ...
            self.$motai=$('<div>').appendTo("body").append(this.$forgetHtml)
                .css({"z-index":"9999","position":"absolute","top":"0px","left":"0px","width":"100%"/*document.body.clientWidth||document.documentElement.clientWidth*/,"height":"100%"/*document.body.clientHeight||document.documentElement.clientHeight*/,"background-color":"rgba(0,0,0,0.5)"})
                ...
                if(validator.result("#forget-password-formid")){
                    ...
                    option.success=function(data){
                        ...
                        if(data.error){
                            ...
                            self.$motai.find("#forget-window").find(".temp-element").remove().end().append($successSend)
                                .append($("<p>"+locale.get("password_has_been_sent_to_the_email")+"!"+"</p>").css({
                                    "line-height":"35px",
                                    "color":"#5F962E",
                                    "height":"35px",
                                    "font-size":"20px",
...
//            "<div class='title-for-company' lang='{text:inhand_device_cloud}'></div>"+
        ...
        this.showHtml=function(){
            self.$motai=$("<div>").appendTo("body")
                ...
                .css({"position":"fixed","z-index":"9999","top":"0px","left":"0px","width":"100%"/*document.body.clientWidth||document.documentElement.clientWidth*/,"height":"100%"/*document.body.clientHeight||document.documentElement.clientHeight*/,"background-color":"rgba(0,0,0,0.5)"})
                .bind("click",function(e){
        ...
        this.event=function(){
            ...
            $("#button-immeditately-regist").bind("click",function(e){self.buttonClickBindAndUnbind(e)});
        };
        //注册提交,$obj按钮对象
...
//			userpassword:userpassword,
            ...
            option.success=function(data){
                ...
                if(data.error){
                    ...
                    $("button.btn-send-email-again").bind("click",function(e){resendEmail(e)});
                    //登录按钮的click事件处理程序
...
//						}
    ...
    this.checkfn=function(e){
        ...
        setTimeout(function(){self.getInputText(e)},"100");
    };
