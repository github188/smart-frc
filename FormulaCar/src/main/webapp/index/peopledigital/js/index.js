...
this._promptCurrentLang=function(){
        	...
        	if(lang=="en"){
        		...
        		$("#lang-en").css("color","#C33427");
        	}else if(lang=="zh_CN"){
        		$("#lang-zh").css("color","#C33427");
...
function Register(){
	...
	this.$registHtml=$("<form class='content-main form-for-registe' id='form-for-registe'>"+
							"<div class='title-for-company'></div>"+
	...
	this.showHtml=function(){
		...
		this.$registHtml.animate({"top":(height/6)+"px"},"1000",function(){
			...
			$("<a href='' target='_blanket' class='anchor-service-rule'></a>").attr('href',"javascript:void(0)").appendTo($(".bottom-service-rule")).html("&nbsp;"+locale.get("term_service"));
			self._showAuthcode();
