	...
	var smartVm={
		...
		subNavs:[{
			...
			subModule:[{                         //二级菜单
				...
				order : 2,
				operation:["r","w"],
				url : "./operation_manage/channelTemplate/channelMain.js"
			},{
				name:"inbox",//工控机
				defaultShow : true,
				order : 3,
	...
	var stock = {
			...
			subNavs:[{
				...
				subModule:[{                         //二级菜单
					...
					order : 0,
					operation:["r","w"],
					url : "./operation_manage/replenishmentv3/reconciliation/reconciliationMan.js"
				},/*{
					...
					order : 3,
					operation:["r","w"],
					url : "./operation_manage/replenishmentv3/plan/planMain.js"
				},{
					name:"replenishment_record",//补货记录
					defaultShow : true,
					order : 4,
					operation:["r"],
					url : "./operation_manage/replenishmentv3/record/recordMain.js"
				},{
					name:"replenishment_reconciliation",//补货对账
					defaultShow : true,
					order : 5,
					operation:["r"],
					url : "./operation_manage/replenishmentv3/statement/statementMain.js"
				}]
			}]
	 };
	//告警  
...
//				}
	...
	var appConfig = {
		modules : [ monitor, organization,smartVm,product,statistics,stock,alarm,services,system,adminView]
	}
