	...
	var replenish = {
			...
			subNavs:[{
				...
				subModule:[/*{                         //二级菜单
					...
					name:"replenishment_record_old",//补货记录(旧)
					defaultShow : true,
					order : 3,
					operation:["r"],
					url : "./operation_manage/replenishment/record/recordMain.js"
				},{                         
					name : "inventory_status_old", //库存状态
					defaultShow : true,
					order : 4,
					operation:["r"],
	...
	var adminView = {
			...
			subNavs:[{
				...
				subModule:[{
					...
					name : "send_email", //邮件发送
					defaultShow : true,
					order : 4,
					operation:["r"],
					url : "./system_manage/emailSendMan/emailSendMain.js"
				}]
			}]
		};
	var appConfig = {
