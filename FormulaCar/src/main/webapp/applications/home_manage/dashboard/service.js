    ...
    var Service = Class.create({
      ...
      getAreaDataByUserId: function(userId, callback, context) {
       ...
       getDayAllStatisticByArea:function(startTime,endTime,areaIds,callback,context){
        ...
        getMonthAllStatisticByArea:function(startTime,endTime,areaIds,callback,context){
        	cloud.Ajax.request({
                url : "api/areaStatistic/monthday",
                type : "get",
                parameters : {
                	startTime : startTime,
                	endTime : endTime,
        ...
        getYearAllStatisticByArea:function(startTime,endTime,areaIds,callback,context){
        	cloud.Ajax.request({
                url : "api/areaStatistic/everyyear",
                type : "get",
                parameters : {
                	startTime : startTime,
                	endTime : endTime,
