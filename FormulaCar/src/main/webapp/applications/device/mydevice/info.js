...
//			
		...
		renderRemoteControllButton:function(deviceInfo){
			 ...
			 if(deviceInfo.online == 1 && (deviceInfo.model.search(/^(IR6XX|IR7XX|IR8XX|IR9XX|IG601|IP800){1}.+$/i) > -1)){
		...
		deleteKey:function(deviceId){
			...
			cloud.Ajax.request({
				...
				success:function(data){
					dialog.render({
						text:locale.get("reset")+locale.get("success")
					});
...
//		 				}
	 				...
	 				if(p2=="p"||p2=="P"){
	 					self.selectModel("IG601_SHPA+",deviceType);
	 				}
	 			}
		}
