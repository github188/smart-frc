...
define(function(require) {
	...
	positions = {
		...
		"right bottom": gm.ControlPosition.RIGHT_BOTTOM,
...
//		return types[type.trim()];
	...
	var Polygon = Class.create({
		initialize:function(){
			this.object = new gm.Polygon();
			this.object.setOptions(polyOptions);
		},
	...
	var Map = Class.create(cloud.Component, {
		initialize: function($super, options) {
			...
			var config = {
				zoom: 4, //this view could watch all of china.
				streetViewControl: false, //disable street view.
				center: new LonLat(116.40752524137497,37.90409081319256), //default center is chengdu.
				mapTypeId: "road",
		...
		addListener:function(name,callback,context){
