                        ...
                        success: function(data2) {
                            ...
                            if (self.device.total == 0) {
                                ...
                                pieData = [
                                    [locale.get({
                                        lang: "online"
                                    }), self.device.online / self.device.total],
                                    [locale.get({
                                        lang: "offline"
                                    }), self.device.offline / self.device.total]
                                ]
                            }
                            self._renderPie({
                                element: "#device-pie",
                                title: locale.get({
                                    lang: "gateway_online_state"
                                }),
                                seriesName: locale.get({
                                    lang: "gateway_number"
                                }),
                                data: pieData
                            });
                                        ...
                                        success: function(data) {
                                            ...
                                            if (self.device.total == 0) {
                                                ...
                                                pieData = [
                                                    [locale.get({
                                                        lang: "construction"
                                                    }), self.device.construction / businessTotal],
                                                    [locale.get({
                                                        lang: "commissioning"
                                                    }), self.device.commissioning / businessTotal],
                                                    [locale.get({
                                                        lang: "fault"
                                                    }), self.device.fault / businessTotal],
                                                    [locale.get({
                                                        lang: "overhaul"
                                                    }), self.device.overhaul / businessTotal]
                                                ]
                                            }
                                            self._renderPie({
                                                element: "#device-business-state-pie",
                                                title: locale.get({
                                                    lang: "gateway_business_state"
                                                }),
                                                seriesName: locale.get({
                                                    lang: "gateway_number"
                                                }),
                                                                        ...
                                                                        success: function(data) {
                                                                            ...
                                                                            cloud.Ajax.request({
                                                                                ...
                                                                                success: function(data) {
                                                                                    ...
                                                                                    $("#shpa-total").text(self.device.SHPA);
                                                                                    ...
                                                                                    if (self.device.total == 0) {
                                                                                        ...
                                                                                        pieData = [
                                                                                            ...
                                                                                            ['SHPA+', self.device.SHPA / self.device.total],
                                                                                            [locale.get({
                                                                                                lang: "others"
                                                                                            }), self.device.othernetwork / self.device.total]
                                                                                        ]
                                                                                    }
                                                                                    self._renderPie({
                                                                                        element: "#device-network-pie",
                                                                                        title: locale.get({
                                                                                            lang: "gateway_network_type"
                                                                                        }),
                                                                                        seriesName: locale.get({
                                                                                            lang: "gateway_number"
                                                                                        }),
                        ...
                        success: function(data) {
                            ...
                            if (self.site.total == 0) {
                                ...
                                pieData = [
                                    [locale.get({
                                        lang: "online"
                                    }), self.site.online / self.site.total],
                                    [locale.get({
                                        lang: "offline"
                                    }), self.site.offline / self.site.total]
                                ]
                            }
                            self._renderPie({
                                element: "#site-pie",
                                title: locale.get({
                                    lang: "site_online_state"
                                }),
                                seriesName: locale.get({
                                    lang: "site_number"
                                }),
                                        ...
                                        success: function(data) {
                                            ...
                                            if (self.site.total == 0) {
                                                ...
                                                pieData = [
                                                    [locale.get({
                                                        lang: "construction"
                                                    }), self.site.construction / businessTotal],
                                                    [locale.get({
                                                        lang: "commissioning"
                                                    }), self.site.commissioning / businessTotal],
                                                    [locale.get({
                                                        lang: "fault"
                                                    }), self.site.fault / businessTotal],
                                                    [locale.get({
                                                        lang: "overhaul"
                                                    }), self.site.overhaul / businessTotal]
                                                ]
                                            }
                                            self._renderPie({
                                                element: "#site-business-state-pie",
                                                title: locale.get({
                                                    lang: "site_business_state"
                                                }),
                                                seriesName: locale.get({
                                                    lang: "site_number"
                                                }),
