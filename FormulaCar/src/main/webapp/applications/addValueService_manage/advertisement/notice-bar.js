define(function(require){
    ...
    var NoticeBar = Class.create(cloud.Component, {
    	...
    	draw:function(){
              ...
              "<label style='margin:auto 10px auto 10px'>"+locale.get({lang:"advertise_name"})+" </label>" +
        ...
        _renderBtn: function(){
            ...
            var deliveryBtn = new Button({
                text: locale.get({lang:"immediate_delivery"}),
                container: $("#search-bar"),
                events: {
                    click: function(){
                    	self.fire("puton");
            ...
            if(permission.app("advertisement_release").read){
            	if(queryBtn) queryBtn.show();
            }else{
            	if(queryBtn) queryBtn.hide();
            }
            if(permission.app("advertisement_release").write){
