    ...
    var NoticeBar = Class.create(cloud.Component, {
    	...
    	draw:function(){
              ...
              var $htmls = $(+"<div></div>" +
            		  ...
            		  locale.get({lang: "automat_no1"})+
    	              "&nbsp;&nbsp;<input style='width:200px' type='text'  id='assetSearch' />" +
    	              "</div>");
        ...
        _renderBtn: function(){
            ...
            if(permission.app("advertisement_broadcast").read){
            	if(queryBtn) queryBtn.show();
            }else{
            	if(queryBtn) queryBtn.hide();
            }
            /*if(permission.app("advertisement_broadcast").write){
