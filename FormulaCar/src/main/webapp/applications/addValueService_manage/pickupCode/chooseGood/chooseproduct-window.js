define(function(require) {
    ...
    var winHtml = require("text!./chooseGood.html");
    ...
    var list = Class.create(cloud.Component, {
        ...
        loadData: function() {
            ...
            Service.getGoodsInfo(searchData,0, pageDisplay, function(data) {
            	console.log(data);
            ...
            if (this.page) {
                ...
                this.page = new Paging({
                    ...
                    requestData: function(options, callback) {
                        var searchData = self.getQueryData();
                        Service.getGoodsInfo(searchData,options.cursor, options.limit, function(data) {
                            callback(data);
                        },self);
