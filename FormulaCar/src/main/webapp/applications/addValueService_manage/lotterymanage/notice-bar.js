define(function(require){
    ...
    var NoticeBar = Class.create(cloud.Component, {
    	...
    	draw:function(){
              ...
              "<label style='margin:auto 10px auto 10px'>"+locale.get({lang:"lottery_name"})+" </label>" +
        ...
        _renderBtn: function(){
            ...
            if(permission.app("lottery_allocation").read){
            ...
            if(permission.app("lottery_allocation").write){
