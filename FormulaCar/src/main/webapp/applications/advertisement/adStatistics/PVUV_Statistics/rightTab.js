...
//            this._renderTable();
        ...
        _render:function(){
            this.toolbar = $("<div class='subTab-toolbar'><div class='toolbar-right'></div></div>").appendTo(this.element);
            this.content = $("<div class='subTab-content'></div>").appendTo(this.element);
            var userContentheight = $(".pvuvStaContent").parent().height();
            this.element.height(userContentheight-230);
        },
        ...
        _renderLayout:function(){
            this.element.layout({
                ...
                north: {
                    paneSelector: ".subTab-toolbar",
                    size: 30
                },
                center: {
                    paneSelector: ".subTab-content"
                }
            })
        },

        renderTable:function(data){
            this.content.empty();//destroy content el
            ...
            this.service.getResourcesByType({siteId:this.siteId, id:data.id, order:order, name:name}, function(datas){
...
//                        }
        ...
        _renderToolbar:function(){
            var self = this;
            var rightbar = self.toolbar.find(".toolbar-right")
            //back btn
            //search
