define(function(require) {
    ...
    var html = require("text!./productMain.html");
    ...
    var operationMenu = Class.create(cloud.Component, {
        ...
        _render: function() {
        	...
        	if(oid == '0000000000000000000abcde'){ 
        		$(".container-hd").html('');
        		$(".container-hd").append("<h2><span >"+locale.get({lang:"current_location_manage_product"})+"</span></h2>");
        	}
        ...
        renderContent: function() {
          var areaMan_Array = ["smart_vending_product_list"];
          if (this.statusMg) {
          ...
          this.statusMg = new statusMg({
              ...
              "events": {
                   click: function(id) {
                        ...
                        if (id == "smart_vending_product_list") {
