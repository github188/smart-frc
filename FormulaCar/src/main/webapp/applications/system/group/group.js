define(function (require) {
    ...
    var Group = Class.create(cloud.Component, {
        initialize: function ($super, options) {
            $(".main_bd").append($("<div>").attr("id", "privilege_test_content"));
            this.element = $("#privilege_test_content");
            $("#privilege_test_content").css("height","700px");
            $("#privilege_test_content").css("position","relative");
            $("#privilege_test_content").css("overflow","hidden");
            this.elements = {
                tag: {
                    id: "group-tag"
                },
        ...
        _renderContent: function (_id) {
            ...
            var content = new Content({
                ...
                events: {
                    beforeLoad: function () {
                        cloud.util.mask("#privilege_test_content");
                    },
                    afterLoad: function () {
                        cloud.util.unmask("#privilege_test_content");
                    }
                }
            });
        },
