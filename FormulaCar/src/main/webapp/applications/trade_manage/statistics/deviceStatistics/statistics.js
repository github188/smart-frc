define(function(require) {
    ...
    var trade = Class.create(cloud.Component, {
        ...
        _render: function() {
            ...
            $("#autoNum").append("<label style='margin-left: -5px;' id='trade_automatNo'>" + locale.get('site_name') + "</label>" +
                "<input style='width:283px;margin-left: 5px;' type='text' id='site_name' placeholder='" + locale.get('more_query_site') + "'/>&nbsp;&nbsp;");
        },
                ...
                events: {
                    click: function() {
                        ...
                        if (byDate) {
                            ...
                            self.getEveryDay(startTime, endTime, siteName);
                        }
                        //月报表
                        if (byMonth) {
        ...
        getEveryDay: function(startTime, endTime, siteName) {
            ...
            Service.getLinesByUserId(userId, function(linedata) {
                ...
                Service.getDeviceDayStatistic(startTime, endTime, siteName, lineIds, function(data) {
                    ...
                    if (data.result) {
                        ...
                        self.renderPieChart(site);
                        self.renderbarChart(siteName, siteAmount);
        ...
        getEveryMonth: function(startTime, endTime, siteName) {
            //cloud.util.mask("#trade");
            var self = this;
            ...
            Service.getLinesByUserId(userId, function(linedata) {
                ...
                self.lineIds = lineIds;
                Service.getDeviceMonthStatistic(startTime, endTime, siteName, lineIds, function(data) {
                    if (data.result) {
                        var site = data.result[0].site;
                        var siteName = data.result[0].siteName;
                        var siteAmount = data.result[0].siteAmount;
        ...
        getEveryYear: function(startTime, endTime, siteName) {
            //cloud.util.mask("#trade");
            var self = this;
            var userId = cloud.storage.sessionStorage("accountInfo").split(",")[1].split(":")[1];
            var roleType = permission.getInfo().roleType;
            Service.getLinesByUserId(userId, function(linedata) {
                ...
                self.lineIds = lineIds;
                Service.getDeviceYearStatistic(startTime, endTime, siteName, lineIds, function(data) {
        ...
        renderPieChart: function(data) {
            ...
            $('#pie-content').highcharts({
                ...
                title: {
                    text: locale.get("site_saleamount_list"),
                },
                tooltip: {
        ...
        renderbarChart: function(bar, type) {
            ...
            $('#top-content').highcharts({
                ...
                title: {
                    text: locale.get("site_sale_list"),
                },
                navigator: {
                    enabled: false
                },
