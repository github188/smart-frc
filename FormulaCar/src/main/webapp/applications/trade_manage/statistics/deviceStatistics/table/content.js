define(function(require) {
    ...
    var list = Class.create(cloud.Component, {
        ...
        render: function() {
            ...
            $("#paging-limit-text1").text(locale.get({
                lang: "per_page"
            }));
            $("#page_total").text(locale.get({
                lang: "page_total"
            }));
            $("#nooldle").text(locale.get({
                lang: "nooldle"
            }));
        },
        ...
        _renderTable: function() {
            ...
            $("#trade_sta_list_table-table").css("margin-bottom", "50px");
        ...
        setDataTable: function() {
            ...
            var arr = [];
            var sitePay = self.data.result[0].sitePay;
            ...
            arr = self.data.result[0].sitePay;
            self.dataA = arr;
            var temp = [];
            ...
            var cell = [];
            if (self.data.result[0].sitePay.length > 0) {
        ...
        _renderRefresh: function(arr) {
            ...
            if (arr.length > 0) {
                ...
                for (var j = 2; j < sl.length - 1; j++) {
                    $("#trade_sta_list_table-table").find("thead th").eq(j).show();
                    var tf = false;
                    for (var k = 1; k < tableObj.rows.length; k++) {
