define(function(require){
	...
	var Window = Class.create(cloud.Component,{
		...
		_renderWindow:function(){
		    ...
		    $("#download_device").attr("href",host+"/DeviceNetwork/downloads/rfid.xls");
			this.window.show();	
			this._renderBtn();
		...
		_renderBtn:function(){
		    ...
		    $("#input-submit").bind("click",function(){
				 ...
				 var url = host + "/api/frcimports/rfid"+ "?oid="+oid+"&languge="+languge+"&access_token="+cloud.Ajax.getAccessToken();
				 var options = {  
							         url:url,   
							         type:'post',   
