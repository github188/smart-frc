define(function(require) {
    ...
    var Service = Class.create({
       ...
       getSalesByEmail:function(email,callback,context){
     	   var self = this;
           cloud.Ajax.request({
               url: "gapi/sales/name",
               type: "GET",
        ...
        getJDconfigByUserId:function(userId,callback,context){
     	   var self = this;
           cloud.Ajax.request({
               url: "api/jd_area/"+userId,
               type: "GET",
               success: function(data) {
                   callback.call(context || self, data);
               }
       ...
       JDConfigManage:function(name,areaIds,config,callback,context){
     	   var self = this;
           cloud.Ajax.request({
               url: "api/jd_area/add",
               type: "POST",
        ...
        getUserByName:function(name,callback,context){
        	   var self = this;
               cloud.Ajax.request({
                   url: "api/smartUser",
                   type: "GET",
        ...
        getAreaPayByAreaList:function(areas,callback,context){
       	   var self = this;
            cloud.Ajax.request({
                url: "api/smartAreaPay",
                type: "GET",
                parameters: {
                	areas:areas
                },
        ...
        addSales:function(obj,callback,context){
			cloud.Ajax.request({
                url : "gapi/sales/add",
                type : "post",
                data:obj,
		...
		getSalesById:function(id,callback,context){
			cloud.Ajax.request({
                url : "gapi/sales/"+id,
                type : "get",
                parameters:{
		...
		updateSalesById:function(id,obj,callback,context){
			cloud.Ajax.request({
                url : "gapi/sales/"+id,
                type : "put",
                data:obj,
		...
		deleteSales:function(id,callback,context){
			cloud.Ajax.request({
                url : "gapi/sales/"+id,
                type : "delete",
                success : function(data) {
	   ...
	   getUserInfo: function(start,limit,callback, context) {
   		...
   		getSmartUserConfigFlag: function(id,areas,callback, context) {
   			cloud.Ajax.request({
                url : "api/smartUser/configflag",
                type : "get",
                parameters : {
                	areas : areas,
                	userId:id
   		...
   		getAllUserInfo: function(start,limit,callback, context) {
   			cloud.Ajax.request({
                ...
                success : function(datas) {
                	...
                	if(datas.result.length>0){
                		for(var i=0;i<datas.result.length;i++){
                			map[datas.result[i].userId] = datas.result[i].configFlag;
                		}
                	}
                	cloud.Ajax.request({
                        url : "api2/users",
                        ...
                        success : function(data) {
                        	if(data.result.length>0){
                        		for(var i=0;i<data.result.length;i++){
                        			for(var key in map)  {
                        				if(data.result[i]._id.toLocaleLowerCase() == key){
                        					data.result[i].configFlag = map[key];
                        				}
                        			}
                        		}
                        	}
