define(function(require){
    ...
    var NoticeBar = Class.create(cloud.Component, {
    	...
    	draw:function(){
              ...
              "<label style='margin:auto 10px auto 10px;margin-right: 2px;'>"+locale.get({lang:"user_name"})+" </label>" +
        ...
        _renderBtn: function(){
            ...
            if(permission.app("user_manager").read){
            	if(queryBtn) queryBtn.show();
            }else{
            	if(queryBtn) queryBtn.hide();
            }
            if(permission.app("user_manager").write){
