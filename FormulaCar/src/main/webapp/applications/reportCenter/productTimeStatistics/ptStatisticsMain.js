define(function(require) {
    ...
    var html = require("text!./ptStatisticsMain.html");
    ...
    var operationMenu = Class.create(cloud.Component, {
        ...
        renderContent: function() {
          var areaMan_Array = ["commodity_time_period_statistics"];
          if (this.statusMg) {
          ...
          this.statusMg = new statusMg({
              ...
              "events": {
                   click: function(id) {
                        ...
                        if (id == "commodity_time_period_statistics") {
            ...
            $("#commodity_time_period_statistics").click();
        }
    });
