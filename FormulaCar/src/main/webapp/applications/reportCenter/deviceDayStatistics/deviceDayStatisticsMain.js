define(function(require) {
    ...
    var html = require("text!./deviceGoodsStatisticsMain.html");
   ...
   // var statistics_Mg = require("./list");
    ...
    var operationMenu = Class.create(cloud.Component, {
        ...
        renderContent: function() {
          var areaMan_Array = ["single_day_sales_statistics"];
          if (this.statusMg) {
          ...
          this.statusMg = new statusMg({
              ...
              "events": {
                   click: function(id) {
                        ...
                        if (id == "single_day_sales_statistics") {
            ...
            $("#single_day_sales_statistics").click();
        }
    });
