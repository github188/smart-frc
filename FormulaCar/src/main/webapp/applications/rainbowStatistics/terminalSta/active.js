    ...
    var userCount = Class.create(cloud.Component,{
        ...
        render:function(){
            ...
            this.dialog = new DashBoard({
                ...
                title : locale.get("active_terminal"),//"活跃终端统计",
                width : width,
                winHeight:winHeight,
                winWidth:winWidth,
                events:{
...
//                            groupPixelWidth:40,
                ...
                yAxis: [{ // Primary yAxis
                    ...
                    title: {
                        margin : -970,
                        text: locale.get("active_terminal_count"),//'活跃终端数',
                        style: {
                            color: '#89A54E'
                        }
                    }
                ...
                series: [{
                    name: locale.get("total_terminal"),//"累计终端数",
                    color: '#4572A7',
                    type: 'area',
                    yAxis: 1,
                    data: this.totalData,
                    ...
                    name: locale.get("active_terminal_count"),//'活跃终端数',
                    color: '#89A54E',
                    type: 'column',
            ...
            this.service.getActiveTerminal(data,function(result){
                ...
                if(registUserChart){
                    ...
                    self.chart.addSeries({
                        id:"registUser",
                        name: locale.get("active_terminal_count"),//'活跃终端',
                        color: '#89A54E',
                        type: 'column',
                        data: result,
                        tooltip: {
