...
//                   }
        ...
        setContent : function(){
            var html = "<div class='user-activecount'></div>"
        ...
        setWindowContent:function(){
            this.winCharContainer = $("<div class='user-activecount-chart-container'></div>")
...
//                        lineWidth : 1,
        ...
        getData:function(oid,mask){
            ...
            this.chart = this.element.find(".user-activecount").highcharts()
...
//           console.log(totalData,"totalData");
        ...
        renderChart : function(){
            this.element.find(".user-activecount").highcharts("StockChart",{
                chart: {
                    zoomType: 'x',
                    spacing:[10 ,20, 15, 20]
