...
define(function(require){
    ...
    var totalUser = Class.create(cloud.Component,{
        ...
        _render:function(){
            ...
            var html = "<div class='sta-box-user sta-box'>" +
                "<div class='sta-box-title'>"+locale.get("total_access_users")+"</div>" +
...
//            this.element.find(".sta-box-details").width(width-100);
            this.setData();
            this.element.find(".sta-box-user").width(width).bind("click",function(){
        ...
        _renderAndOpenWin : function(){
            ...
            if(!this.window){
                this.window =  new Window({
                    container : "body",
                    title : locale.get("user_statistics"),
                    top: "center",
                    left: "center",
                    height: winHeight,
                    width: winWidth,
