    ...
    var registUser = Class.create(cloud.Component,{
        ...
        _render:function(){
            ...
            this.dialog = new DashBoard({
                ...
                title : locale.get("new_user_stat"),
                width : width,
                winHeight : winHeight,
                winWidth : winWidth,
                events : {
...
//                                ['week',[1]],
                ...
                yAxis: [{ // Primary yAxis
                    ...
                    title: {
                        margin : -1060,
                        text: locale.get("new_user"),//'在线用户数',
                        style: {
                            color: COLOR
                        }
                    }
                ...
                series: [{
                    name: locale.get("new_user"),//'在线用户数',
                    color: COLOR,
                    type: 'column',
...
//                startTime : date - 6*30*86400*1000
            ...
            this.service.getRegistUser(data,function(result){
