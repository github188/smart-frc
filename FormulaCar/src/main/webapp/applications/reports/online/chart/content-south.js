...
//			this._addButton();
		...
		load:function(listObj){
			...
			this.service.getLinesByUserId(userId,function(linedata){
                 var lineIds=[];
            	 ...
            	 self.service.getSiteList(listObj,0,self.pageDisplay,lineIds,function(data){
        	...
        	this.paging = new Paging({
				...
				requestData:function(options,success){
					...
					self.service.getLinesByUserId(userId,function(linedata){
	                	 ...
	                	 self.service.getSiteList(self.obj1,options.cursor,options.limit,lineIds,function(returnData){
								success(returnData);
