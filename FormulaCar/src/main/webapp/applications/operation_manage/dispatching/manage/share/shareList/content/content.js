...
define(function(require){
	...
	var Content = Class.create(cloud.Component,{
		initialize:function($super,options){
			...
			this.elements = {
	           toolbar:"share-content-table-toolbar",
	           table: "share-content-table-content",
	           paging: "share-content-table-paging"
	        };
			this.table = "";
			this.display = null;
			this.pageDisplay = 10;
		...
		_renderLayout:function(){
			...
			this.element.css({"height":($("#manage_share_share_info").height()-31)+"px"});
			...
			$("#"+this.elements.toolbar).css({"line-height":$("#"+this.elements.toolbar).height()+"px"});
		},
        ...
        loadTableData : function() {
			...
			var data = 
			{"total":4,"result":[
                {"automatIndex":"55","createTime":"2014-11-24 12:10:12","automatSiteNo":"0001","automatSiteName":"映翰通望京11层西区","automatSiteGroup":"映翰通办公室","automatSiteStatus":"未激活","automatSiteAddress":"望京科技园启明国际大厦"},
                {"automatIndex":"54","createTime":"2014-11-24 12:10:12","automatSiteNo":"0002","automatSiteName":"百度上地办公室3层西区","automatSiteGroup":"百度上地办公室","automatSiteStatus":"在线","automatSiteAddress":"上地七街blabla"},
                {"automatIndex":"53","createTime":"2014-11-24 12:10:12","automatSiteNo":"0003","automatSiteName":"朝阳大悦城11层西区","automatSiteGroup":"朝阳大悦城","automatSiteStatus":"离线","automatSiteAddress":"朝阳区"},
                {"automatIndex":"52","createTime":"2014-11-24 12:10:12","automatSiteNo":"0004","automatSiteName":"顺义后沙峪映翰通工厂","automatSiteGroup":"映翰通","automatSiteStatus":"在线","automatSiteAddress":"顺义"}
             ],"limit":4,"cursor":0};
