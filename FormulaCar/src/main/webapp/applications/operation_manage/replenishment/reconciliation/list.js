		 ...
		 render: function(data, type, row) {
             ...
             if (data) {
            	 ...
            	 display += new Template(
            			 "<div style=' background-color:#eee; height:14px;border-radius: 4px; width:120px; border:1px solid #bbb; color:#222;'>"+ 
            		        "<div style='width: "+data+"; background-color:"+color+";height:14px;font-size:12px;text-align: center;'>"+data+"</div>"+ 
            		    "</div>")
	    	             .evaluate({
	    	                 status : ''
	    	             });
		...
		loadTableData : function(limit,cursor) {
			 ...
			 require(["cloud/lib/plugin/jquery.multiselect"], function() {
	            ...
	            Service.getLinesByUserId(userId,function(linedata){
					 ...
					 Service.getAllLineStocks(self.searchData,limit,cursor,function(data){
			 ...
			 if(self.page){
				 ...
				 self.page = new Paging({
        			...
        			requestData:function(options,callback){
        				cloud.util.mask("#stock-table-content");
        				Service.getAllLineStocks(self.searchData, options.limit,options.cursor,function(data){
