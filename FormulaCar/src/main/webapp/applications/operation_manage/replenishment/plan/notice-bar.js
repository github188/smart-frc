define(function(require){
    ...
    var NoticeBar = Class.create(cloud.Component, {
    	...
    	draw:function(){
              ...
              "<label style='margin:auto 10px auto 10px'>"+locale.get({lang:"replenish_plan_name"})+" </label>" +
        ...
        _renderBtn: function(){
            ...
            if(permission.app("replenishment_plan").read){
            ...
            if(permission.app("replenishment_plan").write){
