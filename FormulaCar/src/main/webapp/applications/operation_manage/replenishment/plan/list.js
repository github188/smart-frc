define(function(require){
	...
	var list = Class.create(cloud.Component,{
		...
		loadTableData : function(limit,cursor) {
        	...
        	Service.getAllReplenishPlan(self.searchData,limit,cursor,function(data){
			 ...
			 if(self.page){
				 ...
				 self.page = new Paging({
        			...
        			requestData:function(options,callback){
        				cloud.util.mask("#replenishplan_list_table");
        				Service.getAllReplenishPlan(self.searchData, options.limit,options.cursor,function(data){
	                            ...
	                            dialog.render({
	                                ...
	                                buttons: [{
	                                        ...
	                                        click: function() {
	                                            ...
	                                            Service.deleteReplenishPlan(ids, function(data) {
                                                	self.loadTableData($(".paging-limit-select").val(),0);
                                                });
