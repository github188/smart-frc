define(function(require) {
    ...
    var NoticeBar = Class.create(cloud.Component, {
        ...
        draw: function() {
            ...
            var merchandising_assetId = localStorage.getItem("merchandising_assetId");
            if(merchandising_assetId){
            	$("#searchValue").val(merchandising_assetId);
            }
        ...
        _renderBtn: function() {
            ...
            if(permission.app("merchandising_list").read){
