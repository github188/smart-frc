define(function(require){
    ...
    var transaction_amount = Class.create(cloud.Component,{
        ...
        setWindowContent:function(){
            ...
            Service.getHistoryStatistic(startTime,endTime,function(data){
            	if( data.result.length){
            			var onlineData = data.result[0].amountSum;
        ...
        getData:function(){  
            ...
            Service.getHistoryStatistic(startTime,endTime,function(data){
            	if( data.result.length){
            			var result = data.result[0].amountSum;
                    	var transaction_amountChart = self.chart.get("transaction_amount");
                        if(transaction_amountChart){	
                        	transaction_amountChart.setData(result);
                        }else{
