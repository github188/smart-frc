define(function(require) {
    ...
    var html = require("text!./upgradeMain.html");
    var statusMg = require("../../template/menu");
    var model_Mg = require("./list");
    var adTask_Mg = require("../../addValueService_manage/advertisement/adTask/list");
    ...
    var operationMenu = Class.create(cloud.Component, {
        ...
        renderContent: function() {
          var areaMan_Array = ["upgrade_list","upgrade_task"];
          if (this.statusMg) {
              ...
              "events": {
                   click: function(id) {
                        ...
                        if (id == "upgrade_list") {
                         ...
                         }else if(id == "upgrade_task"){
                        	 if (this.upgradetask_listPage) {
                                 this.upgradetask_listPage.destroy();
                              }
                              this.upgradetask_listPage = new adTask_Mg({
                                 "container": ".main_bd",
                                 type:3
                              });
                         }
