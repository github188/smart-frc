...
/*					bar: {
        ...
        loadData: function() {
            ...
            Service.getLinesByUserId(userId,function(linedata){
                 ...
                 Service.getTradeList(0, pageDisplay,lineIds,self.serialNumber, function(data) {
            ...
            if (this.page) {
                ...
                this.page = new Paging({
                    ...
                    requestData: function(options, callback) {
                        ...
                        Service.getTradeList(options.cursor, options.limit, self.lineIds,self.serialNumber, function(data) {
                            callback(data);
                            cloud.util.unmask("#trade_list_table");
                        });
