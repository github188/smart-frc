	...
	var list = Class.create(cloud.Component,{
		initialize:function($super,options){
		   ...
		   $("#content-table-paging").css("width",$("#content-table-content").width());
		    $("#content-table-paging").css({"margin-top":"0px","bottom":"70px"});
		...
		_renderBtn: function(){
          ...
          //保存
            $("#plan_save").bind("click", function() {
                ...
                if(self.planId != null){
                	Service.updateReplenishPlanV2(finalData,self.planId, function(data) {
                	...
                	Service.addReplenishPlanV2(finalData, function(data) {
