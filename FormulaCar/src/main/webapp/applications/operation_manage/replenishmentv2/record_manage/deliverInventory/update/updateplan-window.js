    ...
    var updateWindow = Class.create(cloud.Component, {
        ...
        _renderWindow: function() {
            ...
            this.adWindow = new _Window({
                container: "body",
                title: locale.get({lang: "update_bill_of_cargo"}),
                top: "center",
                left: "center",
                height: 650,
                width: 1000,
        ...
        _renderTable:function(data){
        	...
        	if(self.hostsf == 1){
        		if(data.status == 1){
        			$("#save").val(locale.get({lang: "unclaimed_goods_confirm"}));
        		}else if(data.status == 2){
        			$("#save").val(locale.get({lang: "back_goods_confirm"}));
        		}else{
