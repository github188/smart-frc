define(function(require){
    ...
    var NoticeBar = Class.create(cloud.Component, {
    	...
    	draw:function(){
              ...
              "<label style='margin:auto 10px auto 10px'>"+locale.get({lang:"bill_of_cargo_number"})+" </label>" +
        ...
        _renderBtn: function(){
            ...
            if(permission.app("replenish_management").read){
            ...
            if(permission.app("replenish_management").write){
