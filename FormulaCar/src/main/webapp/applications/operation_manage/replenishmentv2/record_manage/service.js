define(function(require) {
    ...
    var Service = Class.create({
        ...
        getGoodsList: function(url,goodsname, callback, context) {
        ...
        addDeliverPlan: function(finalData,callback,context){
        	cloud.Ajax.request({
				url:"api/stockmanage",
				type : "post",
				data:finalData,
        ...
        updateDeliverPlan: function(id,finalData,callback,context){
        	cloud.Ajax.request({
				url:"api/stockmanage/"+id,
				type : "put",
				data:finalData,
				success: function(data) {
	                callback.call(context || self, data);
        ...
        getDeliverPlan: function(id,callback,context){
        	cloud.Ajax.request({
				url:"api/stockmanage/"+id,
				type : "get",
				success: function(data) {
        ...
        getAllDeliverPlan:function(searchData,limit,cursor,callback,context){
          	 var self = this;
             searchData.limit = limit;
             searchData.cursor = cursor;
             cloud.Ajax.request({
                 url: "api/stockmanage/list",
                 type: "GET",
        ...
        getDeliverPlanById: function(id,callback,context){
        	cloud.Ajax.request({
				url:"api/stockmanage/"+id,
				type : "get",
				success: function(data) {
        ...
        deleteDeliverPlan: function(ids,callback,context){
        	cloud.Ajax.request({
				url:"api/stockmanage/delBatch",
				type : "post",
				parameters: {
					ids:ids
				},
      ...
      getReplenishForecast:function(searchData,callback,context){
      	 var self = this;
         cloud.Ajax.request({
             url: "api/replenishv3/forecast",
             type: "GET",
             parameters: searchData,
             success: function(data) {
                 callback.call(context || self, data);
