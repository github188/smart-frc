                ...
                events : {
                    "click": function() {
                    	if(type == "add"){
                        	...
                        	var a = /^(\d*|\-?[1-9]{1}\d*)$/;
                            if( !roadNumber.match(a)||roadNumber=="0"||roadNumber==""){
                            	cloud.util.unmask("#automat_model_info");
                            	dialog.render({lang:"automat_enter_road_number_integer"});
                    			return;
                            }
                        	Service.addModel(name,number,manufacturer,roadNumber,description,function(data){
                        		if(data.error!=null){
                        	...
                        	var a = /^(\d*|\-?[1-9]{1}\d*)$/;
                            if( !roadNumber.match(a)||roadNumber=="0"){
                            	cloud.util.unmask(".ui-window-body");
                            	dialog.render({lang:"automat_enter_road_number_integer"});
                    			return;
                            }
                        	Service.updateModel(_id,name,number,manufacturer,roadNumber,description,function(data){
                        		if(data.error!=null){
