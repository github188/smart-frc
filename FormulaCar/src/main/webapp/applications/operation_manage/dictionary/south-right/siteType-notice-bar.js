define(function(require){
    ...
    var NoticeBar = Class.create(cloud.Component, {
    	...
    	draw:function(){
    		  var self = this;
              var $htmls = $(+"<div></div>" +
              "<div id='search-sitetype-bar' style='width:auto;margin-top:5px;margin-left:5px;'>" +
              "<label style='margin:auto 10px auto 10px;margin-right: 5px;'>"+locale.get({lang:"site_type_name"})+" </label>" +
              "<input style='width:200px' type='text'  id='siteTypeName' />&nbsp;&nbsp;"  +
              "</div>");
