define(function(require) {
    ...
    var html = require("text!./goodsType-south-right.html");
    require("cloud/lib/plugin/jquery-ui");
    var NoticeBar = require("./goodsType-notice-bar");
    ...
    var AddProductType = require("./goodsType-window/addproductType-window");
    ...
    var list = Class.create(cloud.Component, {
        ...
        loadData: function(limit,cursor) {
            ...
            Service.getGoodsTypeList(limit, cursor,typename, function(data) {
			 ...
			 if(self.page){
				 ...
				 self.page = new Paging({
	       			...
	       			requestData:function(options,callback){
	       				var typename = $("#typename").val();
	       				Service.getGoodsTypeList(options.limit,options.cursor,typename,function(data){
            ...
            this.noticeBar = new NoticeBar({
                ...
                events: {
                    query: function() {//查询
                        ...
                        Service.getGoodsTypeList(pageDisplay,0,typename, function(data) {
                                ...
                                buttons: [{
                                        ...
                                        click: function() {
                                            for (var i = 0; i < selectedResouces.length; i++) {
                                                ...
                                                Service.deleteGoodsTypeById(_id, function(data) {
