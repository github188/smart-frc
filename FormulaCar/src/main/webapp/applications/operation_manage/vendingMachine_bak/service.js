define(function(require) {
    ...
    var Service = Class.create({
        ...
        getAllSitesByPage: function(area,name,limit,cursor,callback, context) {
            var self = this;
            cloud.Ajax.request({
        ...
        updateAutomat:function(id,area,name,lineId,lineName,siteId,siteName,assetId,goodsConfigs,goodsConfigChange,callback,context){
        	var self = this;
            cloud.Ajax.request({
