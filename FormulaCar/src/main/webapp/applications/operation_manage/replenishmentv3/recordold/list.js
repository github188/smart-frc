define(function(require){
	...
	var columns = [{
		...
		"title":locale.get({lang:"device_shelf_type"}),//售货机类型
		...
		"title":locale.get({lang:"the_total_number_of_replenishment"}),//补货总数
		"dataIndex" : "replenishmentsum",
		"cls" : null,
		"width" : "8%"
	},{
		"title":locale.get({lang:"the_time_of_replenishment"}),//补货时间
		...
		"title":locale.get({lang:"amount_of_1money"}),//1元补币金额
		"dataIndex" : "moneyForone",
		"cls" : null,
		"width" : "10%",
		 render:priceConvertor
	},{
		"title":locale.get({lang:"amount_of_5money"}),//5角补币金额
		"dataIndex" : "moneyForFive",
		"cls" : null,
		"width" : "10%",
		 render:priceConvertor
	},{
		"title":locale.get({lang:"the_type_of_replenishment"}),//补货类型 1：售货机上报 2：手工导入
	...
	var list = Class.create(cloud.Component,{
		...
		loadTableData : function(limit,cursor) {
			...
			Service.getAllDeviceReplenishment(self.searchData,limit,cursor,function(data){
			 ...
			 if(self.page){
				 ...
				 self.page = new Paging({
        			...
        			requestData:function(options,callback){
        				cloud.util.mask("#content-table-content");
        				Service.getAllDeviceReplenishment(self.searchData, options.limit,options.cursor,function(data){
