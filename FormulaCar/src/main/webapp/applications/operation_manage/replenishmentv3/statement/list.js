	...
	var columns = [{
		...
		render:function(data, type, row){
			  ...
			  /*if(data.machineType == 3){
				  ...
				  nocash = data.stockData.saleCount.cpNcashNumSInit;*/
	   		    //}else{
	   		      total = data.saleCount.cpNumSInit;
	   		      cash = data.saleCount.cpCashNumSInit;
	   		      nocash = data.saleCount.cpNcashNumSInit;
	   		    //}
		...
		render:function(data, type, row){
			  ...
			  var total='';var cash='';var nocash='';
	   		      ...
	   		      total = data.saleCount.cpMoneySInit/100;
	   		      cash = data.saleCount.cpCashMoneySInit/100;
	   		      nocash = data.saleCount.cpNcashMoneySInit/100;
