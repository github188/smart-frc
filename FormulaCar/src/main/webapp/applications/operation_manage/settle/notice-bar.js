...
60)), "yyyy/MM/dd")).datetimepicker({
        ...
        _renderBtn: function(area) {
            ...
            $("#"+settleBtn.id).addClass("readClass");
/*            var exportBtn = new Button({
            ...
            if(permission.app("query_not_settled").read){
            	if(queryBtn) queryBtn.show();
            	//if(exportBtn) exportBtn.show();
            }else{
            	if(queryBtn) queryBtn.hide();
            }
            if(permission.app("query_not_settled").write){
            	if(settleBtn) settleBtn.show();
            }else{
            	if(settleBtn) settleBtn.hide();
            }
            $("#search-bar a").css({
