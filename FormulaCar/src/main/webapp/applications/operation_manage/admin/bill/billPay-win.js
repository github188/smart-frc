		...
		_renderForm:function(){				
			var htmls1= "<div style='text-align: center;width: 100%;margin-top: 40px;'>"
					      ...
					      +"<div style='text-align:left;'>"
					        +"<a id='config-cancel' style='margin-top: 8px;margin-left:10px;' class='btn btn-primary submit'>确认收款</a>"
					      +"</div>"
					      +"</td>"
					      +"</tr>"
					      +"</table>"
			...
			$("#config-cancel").click(function(){
		    	...
		    	dialog.render({
                    ...
                    buttons: [{
                            lang: "affirm",
                            click: function() {
                            	Service.affirmBill(self.name,numbers,payTime,function(data){
                            		console.log(data);
                            		dialog.close();
                            		self.window.destroy();
