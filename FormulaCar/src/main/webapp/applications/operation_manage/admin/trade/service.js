define(function(require) {
    ...
    var Service = Class.create({
         ...
         getOrganDayStatistic:function(startTime,endTime,orgName,callback,context){
          	cloud.Ajax.request({
                  url : "api/organStatistic/dayAll",
                  type : "get",
                  parameters : {
                  	startTime : startTime,
                  	endTime:endTime,
      	...
      	getOrganMonthStatistic:function(startTime,endTime,orgName,callback,context){
          	cloud.Ajax.request({
                  url : "api/organStatistic/monthAll",
                  type : "get",
                  parameters : {
                  	startTime : startTime,
                  	endTime:endTime,
      	...
      	getOrganYearStatistic:function(startTime,endTime,orgName,callback,context){
          	cloud.Ajax.request({
                  url : "api/organStatistic/yearAll",
                  type : "get",
                  parameters : {
                  	startTime : startTime,
                  	endTime:endTime,
