define(function(require) {
    ...
    var updateWindow = Class.create(cloud.Component, {
        ...
        getBillDetail:function(){
        	...
        	var display= cloud.util.dateFormat(new Date(this.data.startTime), "yyyy-MM-dd") +" 至 " +cloud.util.dateFormat(new Date(this.data.endTime), "yyyy-MM-dd")
        	$("#useTime").text(display);
