    ...
    var columns = [
                   {
                       ...
                       "title": locale.get({lang: "track_number"}),
                       "dataIndex": "cid",
                       "cls": null,
                       "width": "10%"
                   }, */{
                       "title": locale.get({lang: "stage_type"}),
                       "dataIndex": "machineType",
                       "cls": null,
                       "width": "9%",
                       render: machineTypeConvertor
                   }, {
                       "title": locale.get({lang: "automat_bargain_price"}),
                       "dataIndex": "machineType",
                       "cls": null,
                       "width": "9%",
                       render: machineTypeConvertor
                   }, /*{
                       "title": locale.get({lang: "weight"}),
                       "dataIndex": "locationId",
                       "cls": null,
                       "width": "5%"
                   }, {
                       "title": locale.get({lang: "opponent"}) + "1",
                       "dataIndex": "goodsName",
                       "cls": null,
                       "width": "9%"
                   }, {
                       "title": locale.get({lang: "opponent"}) + "2",
                       "dataIndex": "price",
                       "cls": null,
                       "width": "10%",
                       render: priceConvertor
                   },  {
                       "title": locale.get({lang: "detail_racing"}),
                       "dataIndex": "payStyle",
                       "cls": null,
                       "width": "9%",
                       render: typeConvertor
                   }, {
                       "title": locale.get({lang: "result_racing"}),
                       "dataIndex": "payStatus",
                       "cls": null,
                       "width": "10%",
                       render: payStatusConvertor
                   }, {
                       "title": locale.get({lang: "image"}),
