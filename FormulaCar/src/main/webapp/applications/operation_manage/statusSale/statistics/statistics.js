define(function(require) {
    ...
    var trade = Class.create(cloud.Component, {
        ...
        renderChart: function(data) {
            ...
            var Qrcodepay_amount = (payStyle[17][1] * 100).toFixed(2); //扫码
            var Icbcpay_amount = (payStyle[18][1] * 100).toFixed(2); //工行融e联
            ...
            var Qrcodepay_sum = (payStylesum[17][1] * 100).toFixed(2); //扫码
            var Icbcpay_sum = (payStylesum[18][1] * 100).toFixed(2); //工行融e联


            var countrow = 0;
            if (Icbcpay_amount != 0.00 || Icbcpay_sum != 0) {
                if (countrow >= 3) {
                    $("#payAlert").append("<span>" + locale.get({
                        lang: "IcbcPay_payment"
                    }) + ":</span><span>&nbsp;" + payStyle[18][2] / 100 + "￥&nbsp;(" + Icbcpay_amount + "%)</span><br>");
                    $("#payAlertSum").append("<span>" + locale.get({
                        lang: "IcbcPay_payment"
                    }) + ":</span><span>&nbsp;&nbsp;" + payStylesum[18][2] + "&nbsp;&nbsp;(" + Icbcpay_sum + "%)</span>&nbsp;&nbsp;&nbsp;<br>");
                    countrow = 0;
                } else {
                    $("#payAlert").append("<span>" + locale.get({
                        lang: "IcbcPay_payment"
                    }) + ":</span><span>&nbsp;" + payStyle[18][2] / 100 + "￥&nbsp;(" + Icbcpay_amount + "%)</span>&nbsp;&nbsp;");
                    $("#payAlertSum").append("<span>" + locale.get({
                        lang: "IcbcPay_payment"
                    }) + ":</span><span>&nbsp;&nbsp;" + payStylesum[18][2] + "&nbsp;&nbsp;(" + Icbcpay_sum + "%)</span>&nbsp;&nbsp;&nbsp;");
                    countrow++;
                }

                $("#payStyleTr").append("<td width='" + Icbcpay_amount + "%" + "'><div style='height: 30px;line-height: 30px;text-align: center;color: white;background-color: #BF3EFF;'></div></td>");
                $("#payStyleSumTr").append("<td width='" + Icbcpay_sum + "%" + "'><div style='height: 30px;line-height: 30px;text-align: center;color: white;background-color: #BF3EFF;'></div></td>");
                $("#colorPayStyleTr").append("<td style='text-align: center;'><span style='height: 10px;width: 10px;background-color: #BF3EFF;  display: inline-block;'></span><span style='margin-left:18px;'>" + locale.get({
                    lang: "IcbcPay_payment"
                }) + "</span></td>");
            }

            if (Unionpay_amount != 0.00 || Unionpay_sum != 0) {
                if (countrow >= 3) {
                    $("#payAlert").append("<span>" + locale.get({
                        lang: "UnionPay_payment"
                    }) + ":</span><span>&nbsp;" + payStyle[16][2] / 100 + "￥&nbsp;(" + Unionpay_amount + "%)</span><br>");
                    $("#payAlertSum").append("<span>" + locale.get({
                        lang: "UnionPay_payment"
                    }) + ":</span><span>&nbsp;&nbsp;" + payStylesum[16][2] + "&nbsp;&nbsp;(" + Unionpay_sum + "%)</span>&nbsp;&nbsp;&nbsp;<br>");
                    countrow = 0;
                } else {
                    $("#payAlert").append("<span>" + locale.get({
                        lang: "UnionPay_payment"
                    }) + ":</span><span>&nbsp;" + payStyle[16][2] / 100 + "￥&nbsp;(" + Unionpay_amount + "%)</span>&nbsp;&nbsp;");
                    $("#payAlertSum").append("<span>" + locale.get({
                        lang: "UnionPay_payment"
                    }) + ":</span><span>&nbsp;&nbsp;" + payStylesum[16][2] + "&nbsp;&nbsp;(" + Unionpay_sum + "%)</span>&nbsp;&nbsp;&nbsp;");
                    countrow++;
                }
                ...
                $("#colorPayStyleTr").append("<td style='text-align: center;'><span style='height: 10px;width: 10px;background-color: #00CD00;  display: inline-block;'></span><span style='margin-left:18px;'>" + locale.get({
                    lang: "UnionPay_payment"
                }) + "</span></td>");
            }

            if (Qrcodepay_amount != 0.00 || Qrcodepay_sum != 0) {
                if (countrow >= 3) {
                    $("#payAlert").append("<span>" + locale.get({
                        lang: "QrcodePay_payment"
                    }) + ":</span><span>&nbsp;" + payStyle[17][2] / 100 + "￥&nbsp;(" + Qrcodepay_amount + "%)</span><br>");
                    $("#payAlertSum").append("<span>" + locale.get({
                        lang: "QrcodePay_payment"
                    }) + ":</span><span>&nbsp;&nbsp;" + payStylesum[17][2] + "&nbsp;&nbsp;(" + Qrcodepay_sum + "%)</span>&nbsp;&nbsp;&nbsp;<br>");
                    countrow = 0;
                } else {
                    $("#payAlert").append("<span>" + locale.get({
                        lang: "QrcodePay_payment"
                    }) + ":</span><span>&nbsp;" + payStyle[17][2] / 100 + "￥&nbsp;(" + Qrcodepay_amount + "%)</span>&nbsp;&nbsp;");
                    $("#payAlertSum").append("<span>" + locale.get({
                        lang: "QrcodePay_payment"
                    }) + ":</span><span>&nbsp;&nbsp;" + payStylesum[17][2] + "&nbsp;&nbsp;(" + Qrcodepay_sum + "%)</span>&nbsp;&nbsp;&nbsp;");
                    countrow++;
                }

                $("#payStyleTr").append("<td width='" + Qrcodepay_amount + "%" + "'><div style='height: 30px;line-height: 30px;text-align: center;color: white;background-color:#FF83FA;'></div></td>");
                $("#payStyleSumTr").append("<td width='" + Qrcodepay_sum + "%" + "'><div style='height: 30px;line-height: 30px;text-align: center;color: white;background-color: #FF83FA;'></div></td>");
                $("#colorPayStyleTr").append("<td style='text-align: center;'><span style='height: 10px;width: 10px;background-color: #FF83FA;  display: inline-block;'></span><span style='margin-left:18px;'>" + locale.get({
                    lang: "QrcodePay_payment"
                }) + "</span></td>");
            }

            if (Wechat_amount != 0.00 || Wechat_sum != 0) {
                if (countrow >= 3) {
                    $("#payAlert").append("<span>" + locale.get({
                        lang: "we_chat"
                    }) + ":</span><span>&nbsp;" + payStyle[0][2] / 100 + "￥&nbsp;(" + Wechat_amount + "%)</span><br>");
                    $("#payAlertSum").append("<span>" + locale.get({
                        lang: "we_chat"
                    }) + ":</span><span>&nbsp;&nbsp;" + payStylesum[0][2] + "&nbsp;&nbsp;(" + Wechat_sum + "%)</span>&nbsp;&nbsp;&nbsp;<br>");
                    countrow = 0;
                } else {
                    $("#payAlert").append("<span>" + locale.get({
                        lang: "we_chat"
                    }) + ":</span><span>&nbsp;" + payStyle[0][2] / 100 + "￥&nbsp;(" + Wechat_amount + "%)</span>&nbsp;&nbsp;");
                    $("#payAlertSum").append("<span>" + locale.get({
                        lang: "we_chat"
                    }) + ":</span><span>&nbsp;&nbsp;" + payStylesum[0][2] + "&nbsp;&nbsp;(" + Wechat_sum + "%)</span>&nbsp;&nbsp;&nbsp;");
                    countrow++;
                }
            ...
            if (Alipay_amount != 0.00 || Alipay_sum != 0) {
                if (countrow >= 3) {
                    $("#payAlert").append("<span>" + locale.get({
                        lang: "alipay"
                    }) + ":</span><span>&nbsp;" + payStyle[1][2] / 100 + "￥&nbsp;(" + Alipay_amount + "%)</span><br>");
                    $("#payAlertSum").append("<span>" + locale.get({
                        lang: "alipay"
                    }) + ":</span><span>&nbsp;&nbsp;" + payStylesum[1][2] + "&nbsp;&nbsp;(" + Alipay_sum + "%)</span>&nbsp;&nbsp;&nbsp;<br>");
                    countrow = 0;
                } else {
                    $("#payAlert").append("<span>" + locale.get({
                        lang: "alipay"
                    }) + ":</span><span>&nbsp;" + payStyle[1][2] / 100 + "￥&nbsp;(" + Alipay_amount + "%)</span>&nbsp;&nbsp;");
                    $("#payAlertSum").append("<span>" + locale.get({
                        lang: "alipay"
                    }) + ":</span><span>&nbsp;&nbsp;" + payStylesum[1][2] + "&nbsp;&nbsp;(" + Alipay_sum + "%)</span>&nbsp;&nbsp;&nbsp;");
                    countrow++;
                }
                ...
                $("#colorPayStyleTr").append("<td style='text-align: center;'><span style='height: 10px;width: 10px;background-color: #FD6B6C;  display: inline-block;'></span><span style='margin-left:18px;'>" + locale.get({
                    lang: "trade_alipay"
                }) + "</span></td>");
            }

            if (other_amount != 0.00 || other_sum != 0) {
                if (countrow >= 3) {
                    $("#payAlert").append("<span>" + locale.get({
                        lang: "cash"
                    }) + ":</span><span>&nbsp;" + payStyle[3][2] / 100 + "￥&nbsp;(" + other_amount + "%)</span><br>");
                    $("#payAlertSum").append("<span>" + locale.get({
                        lang: "cash"
                    }) + ":</span><span>&nbsp;&nbsp;" + payStylesum[3][2] + "&nbsp;&nbsp;(" + other_sum + "%)</span>&nbsp;&nbsp;&nbsp;<br>");
                    countrow = 0;
                } else {
                    $("#payAlert").append("<span>" + locale.get({
                        lang: "cash"
                    }) + ":</span><span>&nbsp;" + payStyle[3][2] / 100 + "￥&nbsp;(" + other_amount + "%)</span>&nbsp;&nbsp;");
                    $("#payAlertSum").append("<span>" + locale.get({
                        lang: "cash"
                    }) + ":</span><span>&nbsp;&nbsp;" + payStylesum[3][2] + "&nbsp;&nbsp;(" + other_sum + "%)</span>&nbsp;&nbsp;&nbsp;");
                    countrow++;
                }
                ...
                $("#colorPayStyleTr").append("<td style='text-align: center;'><span style='height: 10px;width: 10px;background-color: #ACCCBD;  display: inline-block;'></span><span style='margin-left:18px;'>" + locale.get({
                    lang: "trade_cash_payment"
                }) + "</span></td>");
            }

            if (BaifuBao_amount != 0.00 || BaifuBao_sum != 0) {
                if (countrow >= 3) {
                    $("#payAlert").append("<span>" + locale.get({
                        lang: "baifubao"
                    }) + ":</span><span>&nbsp;" + payStyle[2][2] / 100 + "￥&nbsp;(" + BaifuBao_amount + "%)</span><br>");
                    $("#payAlertSum").append("<span>" + locale.get({
                        lang: "baifubao"
                    }) + ":</span><span>&nbsp;&nbsp;" + payStylesum[2][2] + "&nbsp;&nbsp;(" + BaifuBao_sum + "%)</span>&nbsp;&nbsp;&nbsp;<br>");
                    countrow = 0;
                } else {
                    $("#payAlert").append("<span>" + locale.get({
                        lang: "baifubao"
                    }) + ":</span><span>&nbsp;" + payStyle[2][2] / 100 + "￥&nbsp;(" + BaifuBao_amount + "%)</span>&nbsp;&nbsp;");
                    $("#payAlertSum").append("<span>" + locale.get({
                        lang: "baifubao"
                    }) + ":</span><span>&nbsp;&nbsp;" + payStylesum[2][2] + "&nbsp;&nbsp;(" + BaifuBao_sum + "%)</span>&nbsp;&nbsp;&nbsp;");
                    countrow++;
                }
                ...
                $("#colorPayStyleTr").append("<td style='text-align: center;'><span style='height: 10px;width: 10px;background-color: #BCBD91;  display: inline-block;'></span><span style='margin-left:18px;'>" + locale.get({
                    lang: "trade_baifubao"
                }) + "</span></td>");
            }
            if (SoundWave_amount != 0.00 || SoundWave_sum != 0) {
                if (countrow >= 3) {
                    $("#payAlert").append("<span>" + locale.get({
                        lang: "trade_soundware"
                    }) + ":</span><span>&nbsp;" + payStyle[4][2] / 100 + "￥&nbsp;(" + SoundWave_amount + "%)</span><br>");
                    $("#payAlertSum").append("<span>" + locale.get({
                        lang: "trade_soundware"
                    }) + ":</span><span>&nbsp;&nbsp;" + payStylesum[4][2] + "&nbsp;&nbsp;(" + SoundWave_sum + "%)</span>&nbsp;&nbsp;&nbsp;<br>");
                    countrow = 0;
                } else {
                    $("#payAlert").append("<span>" + locale.get({
                        lang: "trade_soundware"
                    }) + ":</span><span>&nbsp;" + payStyle[4][2] / 100 + "￥&nbsp;(" + SoundWave_amount + "%)</span>&nbsp;&nbsp;");
                    $("#payAlertSum").append("<span>" + locale.get({
                        lang: "trade_soundware"
                    }) + ":</span><span>&nbsp;&nbsp;" + payStylesum[4][2] + "&nbsp;&nbsp;(" + SoundWave_sum + "%)</span>&nbsp;&nbsp;&nbsp;");
                    countrow++;
                }
                ...
                $("#colorPayStyleTr").append("<td style='text-align: center;'><span style='height: 10px;width: 10px;background-color: #CDAD00;  display: inline-block;'></span><span style='margin-left:18px;'>" + locale.get({
                    lang: "trade_soundwave_pay"
                }) + "</span></td>");
            }
            if (SwingCard_amount != 0.00 || SwingCard_sum != 0) {
                if (countrow >= 3) {
                    $("#payAlert").append("<span>" + locale.get({
                        lang: "trade_swing_card"
                    }) + ":</span><span>&nbsp;" + payStyle[5][2] / 100 + "￥&nbsp;(" + SwingCard_amount + "%)</span><br>");
                    $("#payAlertSum").append("<span>" + locale.get({
                        lang: "trade_swing_card"
                    }) + ":</span><span>&nbsp;&nbsp;" + payStylesum[5][2] + "&nbsp;&nbsp;(" + SwingCard_sum + "%)</span>&nbsp;&nbsp;&nbsp;<br>");
                    countrow = 0;
                } else {
                    $("#payAlert").append("<span>" + locale.get({
                        lang: "trade_swing_card"
                    }) + ":</span><span>&nbsp;" + payStyle[5][2] / 100 + "￥&nbsp;(" + SwingCard_amount + "%)</span>&nbsp;&nbsp;");
                    $("#payAlertSum").append("<span>" + locale.get({
                        lang: "trade_swing_card"
                    }) + ":</span><span>&nbsp;&nbsp;" + payStylesum[5][2] + "&nbsp;&nbsp;(" + SwingCard_sum + "%)</span>&nbsp;&nbsp;&nbsp;");
                    countrow++;
                }
                ...
                $("#colorPayStyleTr").append("<td style='text-align: center;'><span style='height: 10px;width: 10px;background-color: #FFD700;  display: inline-block;'></span><span style='margin-left:18px;'>" + locale.get({
                    lang: "trade_swingcard_pay"
                }) + "</span></td>");
            }
            if (Pos_amount != 0.00 || Pos_sum != 0) {
                if (countrow >= 3) {
                    $("#payAlert").append("<span>" + locale.get({
                        lang: "trade_pos_mach"
                    }) + ":</span><span>&nbsp;" + payStyle[6][2] / 100 + "￥&nbsp;(" + Pos_amount + "%)</span><br>");
                    $("#payAlertSum").append("<span>" + locale.get({
                        lang: "trade_pos_mach"
                    }) + ":</span><span>&nbsp;&nbsp;" + payStylesum[6][2] + "&nbsp;&nbsp;(" + Pos_sum + "%)</span>&nbsp;&nbsp;&nbsp;<br>");
                    countrow = 0;
                } else {
                    $("#payAlert").append("<span>" + locale.get({
                        lang: "trade_pos_mach"
                    }) + ":</span><span>&nbsp;" + payStyle[6][2] / 100 + "￥&nbsp;(" + Pos_amount + "%)</span>&nbsp;&nbsp;");
                    $("#payAlertSum").append("<span>" + locale.get({
                        lang: "trade_pos_mach"
                    }) + ":</span><span>&nbsp;&nbsp;" + payStylesum[6][2] + "&nbsp;&nbsp;(" + Pos_sum + "%)</span>&nbsp;&nbsp;&nbsp;");
                    countrow++;
                }
                ...
                $("#colorPayStyleTr").append("<td style='text-align: center;'><span style='height: 10px;width: 10px;background-color: #EE1289;  display: inline-block;'></span><span style='margin-left:18px;'>" + locale.get({
                    lang: "trade_pos_pay"
                }) + "</span></td>");
            }
            if (OneCard_amount != 0.00 || OneCard_sum != 0) {
                if (countrow >= 3) {
                    $("#payAlert").append("<span>" + locale.get({
                        lang: "one_card_solution"
                    }) + ":</span><span>&nbsp;" + payStyle[7][2] / 100 + "￥&nbsp;(" + OneCard_amount + "%)</span><br>");
                    $("#payAlertSum").append("<span>" + locale.get({
                        lang: "one_card_solution"
                    }) + ":</span><span>&nbsp;&nbsp;" + payStylesum[7][2] + "&nbsp;&nbsp;(" + OneCard_sum + "%)</span>&nbsp;&nbsp;&nbsp;<br>");
                    countrow = 0;
                } else {
                    $("#payAlert").append("<span>" + locale.get({
                        lang: "one_card_solution"
                    }) + ":</span><span>&nbsp;" + payStyle[7][2] / 100 + "￥&nbsp;(" + OneCard_amount + "%)</span>&nbsp;&nbsp;");
                    $("#payAlertSum").append("<span>" + locale.get({
                        lang: "one_card_solution"
                    }) + ":</span><span>&nbsp;&nbsp;" + payStylesum[7][2] + "&nbsp;&nbsp;(" + OneCard_sum + "%)</span>&nbsp;&nbsp;&nbsp;");
                    countrow++;
                }
                ...
                $("#colorPayStyleTr").append("<td style='text-align: center;'><span style='height: 10px;width: 10px;background-color: #F4A460;  display: inline-block;'></span><span style='margin-left:18px;'>" + locale.get({
                    lang: "trade_onecard_pay"
                }) + "</span></td>");
            }
            if (Abc_amount != 0.00 || Abc_sum != 0) {
                if (countrow >= 3) {
                    $("#payAlert").append("<span>" + locale.get({
                        lang: "trade_abc"
                    }) + ":</span><span>&nbsp;" + payStyle[8][2] / 100 + "￥&nbsp;(" + Abc_amount + "%)</span><br>");
                    $("#payAlertSum").append("<span>" + locale.get({
                        lang: "trade_abc"
                    }) + ":</span><span>&nbsp;&nbsp;" + payStylesum[8][2] + "&nbsp;&nbsp;(" + Abc_sum + "%)</span>&nbsp;&nbsp;&nbsp;<br>");
                    countrow = 0;
                } else {
                    $("#payAlert").append("<span>" + locale.get({
                        lang: "trade_abc"
                    }) + ":</span><span>&nbsp;" + payStyle[8][2] / 100 + "￥&nbsp;(" + Abc_amount + "%)</span>&nbsp;&nbsp;");
                    $("#payAlertSum").append("<span>" + locale.get({
                        lang: "trade_abc"
                    }) + ":</span><span>&nbsp;&nbsp;" + payStylesum[8][2] + "&nbsp;&nbsp;(" + Abc_sum + "%)</span>&nbsp;&nbsp;&nbsp;");
                    countrow++;
                }
                ...
                $("#colorPayStyleTr").append("<td style='text-align: center;'><span style='height: 10px;width: 10px;background-color: #C0FF3E;  display: inline-block;'></span><span style='margin-left:18px;'>" + locale.get({
            ...
            if (Game_amount != 0.00) {
                if (countrow >= 3) {
                    $("#payAlert").append("<span>" + locale.get({
                        lang: "trade_game"
                    }) + ":</span><span>&nbsp;" + payStyle[9][2] / 100 + "￥&nbsp;(" + Game_amount + "%)</span><br>");
                    $("#payAlertSum").append("<span>" + locale.get({
                        lang: "trade_game"
                    }) + ":</span><span>&nbsp;&nbsp;" + payStylesum[9][2] + "&nbsp;&nbsp;(" + Game_sum + "%)</span>&nbsp;&nbsp;&nbsp;<br>");
                    countrow = 0;
                } else {
                    $("#payAlert").append("<span>" + locale.get({
                        lang: "trade_game"
                    }) + ":</span><span>&nbsp;" + payStyle[9][2] / 100 + "￥&nbsp;(" + Game_amount + "%)</span>&nbsp;&nbsp;");
                    $("#payAlertSum").append("<span>" + locale.get({
                        lang: "trade_game"
                    }) + ":</span><span>&nbsp;&nbsp;" + payStylesum[9][2] + "&nbsp;&nbsp;(" + Game_sum + "%)</span>&nbsp;&nbsp;&nbsp;");
                    countrow++;
                }
                ...
                $("#colorPayStyleTr").append("<td style='text-align: center;'><span style='height: 10px;width: 10px;background-color: #9F79EE;  display: inline-block;'></span><span style='margin-left:18px;'>" + locale.get({
                    lang: "trade_game_pay"
                }) + "</span></td>");
            } else {
                if (Game_sum != 0.00) {
            ...
            if (OtherPay_amount != 0.00 || OtherPay_sum != 0) {
                if (countrow >= 3) {
                    $("#payAlert").append("<span>" + locale.get({
                        lang: "other"
                    }) + ":</span><span>&nbsp;" + payStyle[15][2] / 100 + "￥&nbsp;(" + OtherPay_amount + "%)</span><br>");
                    $("#payAlertSum").append("<span>" + locale.get({
                        lang: "other"
                    }) + ":</span><span>&nbsp;&nbsp;" + payStylesum[15][2] + "&nbsp;&nbsp;(" + OtherPay_sum + "%)</span>&nbsp;&nbsp;&nbsp;<br>");
                    countrow = 0;
                } else {
                    $("#payAlert").append("<span>" + locale.get({
                        lang: "other"
                    }) + ":</span><span>&nbsp;" + payStyle[15][2] / 100 + "￥&nbsp;(" + OtherPay_amount + "%)</span>&nbsp;&nbsp;");
                    $("#payAlertSum").append("<span>" + locale.get({
                        lang: "other"
                    }) + ":</span><span>&nbsp;&nbsp;" + payStylesum[15][2] + "&nbsp;&nbsp;(" + OtherPay_sum + "%)</span>&nbsp;&nbsp;&nbsp;<br>");
                    countrow++;
                ...
                $("#colorPayStyleTr").append("<td style='text-align: center;'><span style='height: 10px;width: 10px;background-color: #9C9C9C;  display: inline-block;'></span><span style='margin-left:18px;'>" + locale.get({
                    lang: "trade_other"
                }) + "</span></td>");
            }
            if (VipPay_amount != 0.00) {
                if (countrow >= 3) {
                    $("#payAlert").append("<span>" + locale.get({
                        lang: "trade_vip"
                    }) + ":</span><span>&nbsp;" + payStyle[10][2] / 100 + "￥&nbsp;(" + VipPay_amount + "%)</span><br>");
                    $("#payAlertSum").append("<span>" + locale.get({
                        lang: "trade_vip"
                    }) + ":</span><span>&nbsp;&nbsp;" + payStylesum[10][2] + "&nbsp;&nbsp;(" + VipPay_sum + "%)</span>&nbsp;&nbsp;&nbsp;<br>");
                    countrow = 0;
                } else {
                    $("#payAlert").append("<span>" + locale.get({
                        lang: "trade_vip"
                    }) + ":</span><span>&nbsp;" + payStyle[10][2] / 100 + "￥&nbsp;(" + VipPay_amount + "%)</span>&nbsp;&nbsp;");
                    $("#payAlertSum").append("<span>" + locale.get({
                        lang: "trade_vip"
                    }) + ":</span><span>&nbsp;&nbsp;" + payStylesum[10][2] + "&nbsp;&nbsp;(" + VipPay_sum + "%)</span>&nbsp;&nbsp;&nbsp;");
                    countrow++;
                }
                ...
                $("#colorPayStyleTr").append("<td style='text-align: center;'><span style='height: 10px;width: 10px;background-color: #FF34B3;  display: inline-block;'></span><span style='margin-left:18px;'>" + locale.get({
                    lang: "trade_vip"
                }) + "</span></td>");
            } else {
                if (VipPay_sum != 0.00) {
            ...
            if (BestPay_amount != 0.00) {
                if (countrow >= 3) {
                    $("#payAlert").append("<span>" + locale.get({
                        lang: "trade_best_pay"
                    }) + ":</span><span>&nbsp;" + payStyle[11][2] / 100 + "￥&nbsp;(" + BestPay_amount + "%)</span><br>");
                    $("#payAlertSum").append("<span>" + locale.get({
                        lang: "trade_best_pay"
                    }) + ":</span><span>&nbsp;&nbsp;" + payStylesum[11][2] + "&nbsp;&nbsp;(" + BestPay_sum + "%)</span>&nbsp;&nbsp;&nbsp;<br>");
                    countrow = 0;
                } else {
                    $("#payAlert").append("<span>" + locale.get({
                        lang: "trade_best_pay"
                    }) + ":</span><span>&nbsp;" + payStyle[11][2] / 100 + "￥&nbsp;(" + BestPay_amount + "%)</span>&nbsp;&nbsp;");
                    $("#payAlertSum").append("<span>" + locale.get({
                        lang: "trade_best_pay"
                    }) + ":</span><span>&nbsp;&nbsp;" + payStylesum[11][2] + "&nbsp;&nbsp;(" + BestPay_sum + "%)</span>&nbsp;&nbsp;&nbsp;");
                    countrow++;
                }
                ...
                if (BestPay_sum != 0.00) {
                    ...
                    $("#payStyleSumTr").append("<td width='" + BestPay_sum + "%" + "'><div style='height: 30px;line-height: 30px;text-align: center;color: white;background-color: #7A67EE;'></div></td>");
                    $("#colorPayStyleTr").append("<td style='text-align: center;'><span style='height: 10px;width: 10px;background-color: #7A67EE;  display: inline-block;'></span><span style='margin-left:18px;'>" + locale.get({
                        lang: "trade_best_pay"
                    }) + "</span></td>");
                }
            }
            if (JDPay_amount != 0.00) {
                if (countrow >= 3) {
                    $("#payAlert").append("<span>" + locale.get({
                        lang: "trade_jd_pay"
                    }) + ":</span><span>&nbsp;" + payStyle[12][2] / 100 + "￥&nbsp;(" + JDPay_amount + "%)</span><br>");
                    $("#payAlertSum").append("<span>" + locale.get({
                        lang: "trade_jd_pay"
                    }) + ":</span><span>&nbsp;&nbsp;" + payStylesum[12][2] + "&nbsp;&nbsp;(" + JDPay_sum + "%)</span>&nbsp;&nbsp;&nbsp;<br>");
                    countrow = 0;
                } else {
                    $("#payAlert").append("<span>" + locale.get({
                        lang: "trade_jd_pay"
                    }) + ":</span><span>&nbsp;" + payStyle[12][2] / 100 + "￥&nbsp;(" + JDPay_amount + "%)</span>&nbsp;&nbsp;");
                    $("#payAlertSum").append("<span>" + locale.get({
                        lang: "trade_jd_pay"
                    }) + ":</span><span>&nbsp;&nbsp;" + payStylesum[12][2] + "&nbsp;&nbsp;(" + JDPay_sum + "%)</span>&nbsp;&nbsp;&nbsp;");
                    countrow++;
                }
                ...
                $("#colorPayStyleTr").append("<td style='text-align: center;'><span style='height: 10px;width: 10px;background-color: #DB7093;  display: inline-block;'></span><span style='margin-left:18px;'>" + locale.get({
                    lang: "trade_jd_pay"
                }) + "</span></td>");
            } else {
                if (JDPay_sum != 0.00) {
            ...
            if (WechatBarcode_amount != 0.00) {
                if (countrow >= 3) {
                    ...
                    }) + ":</span><span>&nbsp;" + payStyle[13][2] / 100 + "￥&nbsp;(" + WechatBarcode_amount + "%)</span><br>");
                    $("#payAlertSum").append("<span>" + locale.get({
                        lang: "wechat_reversescan_pay"
                    }) + ":</span><span>&nbsp;&nbsp;" + payStylesum[13][2] + "&nbsp;&nbsp;(" + WechatBarcode_sum + "%)</span>&nbsp;&nbsp;&nbsp;<br>");
                    countrow = 0;
                } else {
                    $("#payAlert").append("<span>" + locale.get({
                        lang: "wechat_reversescan_pay"
                    }) + ":</span><span>&nbsp;" + payStyle[13][2] / 100 + "￥&nbsp;(" + WechatBarcode_amount + "%)</span>&nbsp;&nbsp;");
                    $("#payAlertSum").append("<span>" + locale.get({
                        lang: "wechat_reversescan_pay"
                    }) + ":</span><span>&nbsp;&nbsp;" + payStylesum[13][2] + "&nbsp;&nbsp;(" + WechatBarcode_sum + "%)</span>&nbsp;&nbsp;&nbsp;");
                    countrow++;
                }
                ...
                $("#colorPayStyleTr").append("<td style='text-align: center;'><span style='height: 10px;width: 10px;background-color: #76EEC6;  display: inline-block;'></span><span style='margin-left:18px;'>" + locale.get({
                    lang: "wechat_reversescan_pay"
                }) + "</span></td>");
            } else {
            ...
            if (AlipayBarcode_amount != 0.00) {
                if (countrow >= 3) {
                    ...
                    }) + ":</span><span>&nbsp;" + payStyle[14][2] / 100 + "￥&nbsp;(" + AlipayBarcode_amount + "%)</span><br>");
                    $("#payAlertSum").append("<span>" + locale.get({
                        lang: "trade_reversescan_pay"
                    }) + ":</span><span>&nbsp;&nbsp;" + payStylesum[14][2] + "&nbsp;&nbsp;(" + AlipayBarcode_sum + "%)</span>&nbsp;&nbsp;&nbsp;<br>");
                    countrow = 0;
                } else {
                    $("#payAlert").append("<span>" + locale.get({
                        lang: "trade_reversescan_pay"
                    }) + ":</span><span>&nbsp;" + payStyle[14][2] / 100 + "￥&nbsp;(" + AlipayBarcode_amount + "%)</span>&nbsp;&nbsp;");
                    $("#payAlertSum").append("<span>" + locale.get({
                        lang: "trade_reversescan_pay"
                    }) + ":</span><span>&nbsp;&nbsp;" + payStylesum[14][2] + "&nbsp;&nbsp;(" + AlipayBarcode_sum + "%)</span>&nbsp;&nbsp;&nbsp;");
                    countrow++;
                }
                ...
                $("#colorPayStyleTr").append("<td style='text-align: center;'><span style='height: 10px;width: 10px;background-color: #EEEE00;  display: inline-block;'></span><span style='margin-left:18px;'>" + locale.get({
                    lang: "trade_reversescan_pay"
                }) + "</span></td>");
            } else {
        ...
        renderLineChart: function(result, newTimes, map) {
            ...
            $('#line-content').highcharts({
                ...
                //result
                    ...
                    data: result[0].data,
                    tooltip: {
                        valueSuffix: locale.get({lang:"yuan"})
                    }

                }, {
                    name: locale.get( "cars_number"),
                    color: '#458B00',
                    type: 'spline',
                    data: result[1].data,
                    tooltip: {
                    ...
                    name: locale.get( "value_retail_sales"),
                    color: '#458B00',
                    type: 'spline',
                    data: result[1].data,
                    tooltip: {
