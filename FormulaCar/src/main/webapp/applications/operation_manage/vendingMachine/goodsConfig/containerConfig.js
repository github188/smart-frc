 			...
 			if(saveGoodsConfig){
 			    for(var i=0;i<saveGoodsConfig.length;i++){
                    ...
                    if(self.machineType == 3){
                    	capacity = 1;
                    	valve = 0;
                    	capinput = "<input type='text' style='width:40px;height: 10px;margin-left: 12px;text-align:center;line-height:16px;' readonly='readonly' value='"+capacity+"' id='" + saveGoodsConfig[i].location_id + "_capacity_content' placeholder='"+locale.get({lang:"shelf_rong"})+"'/>";
                        valveinput = "<input type='text' style='width:40px;height: 10px;margin-left: -48px;text-align:center;line-height:16px;' readonly='readonly' value='" + valve + "' id='" + saveGoodsConfig[i].location_id + "_valve_content' placeholder='"+locale.get({lang:"shelf_threshold"})+"'/>";
                    }else{
                    	capinput = "<input type='text' style='width:40px;height: 10px;margin-left: 12px;text-align:center;line-height:16px;' value='"+capacity+"' id='" + saveGoodsConfig[i].location_id + "_capacity_content' placeholder='"+locale.get({lang:"shelf_rong"})+"'/>";
                        valveinput = "<input type='text' style='width:40px;height: 10px;margin-left: -48px;text-align:center;line-height:16px;' value='" + valve + "' id='" + saveGoodsConfig[i].location_id + "_valve_content' placeholder='"+locale.get({lang:"shelf_threshold"})+"'/>";
                    }
 	        		...
 	        		roadInfoHtml = roadInfoHtml + "<td style='width:12.5%;'>"+
 	        										"<table style='width:100%'>"+
 	        											...
 	        											"<tr style='height:40px;width:100%;text-align:center;font-size:10px;'  id='"+saveGoodsConfig[i].location_id+"_goods_name'><td><div id='"+saveGoodsConfig[i].location_id+ "_name_div' style='width:117px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;'><span style='font-weight:600' id='"+saveGoodsConfig[i].location_id+"_name_content'>&nbsp;"+"</span></div></td></tr>"+
