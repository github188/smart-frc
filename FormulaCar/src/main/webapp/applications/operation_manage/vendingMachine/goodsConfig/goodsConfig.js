define(function(require) {
    ...
    var config = Class.create(cloud.Component, {
        ...
        showRoads: function(data) {
            ...
            var row = 0;
            var roadInfoHtml = "<table id='road_table' style='width:935px;height:360px;margin-top: 10px;'>";
				...
				for (var i = 0; i < data.length; i++) {
	                if(data[i]!=null){
	                    ...
	                    roadInfoHtml = roadInfoHtml + "<td style='width:12.5%;'>" +
	                            ...
	                            "<tr style='height:40px;width:100%;text-align:center;font-size:10px;'  id='" + data[i].location_id + "_goods_name'><td><div id='"+data[i].location_id+ "_name_div' style='width:117px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;'><span style='font-weight:600' id='" + data[i].location_id + "_name_content'>&nbsp;" + "</span></div></td></tr>" +
