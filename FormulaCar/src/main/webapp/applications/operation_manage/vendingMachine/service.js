define(function(require) {
    ...
    var Service = Class.create({
        ...
        createDeviceListExcel: function(parameters,callback, context) {
        	cloud.Ajax.request({
    	       url : "api/vmreports/automat/create",
 	   	       type : "get",
        ...
        findDeviceListExcel:function(time,report_name,callback,context){
			cloud.Ajax.request({
                ...
                type : "get",
                parameters : {
                	path : "/home/deviceList/"+time+"/"+report_name
                },
                success : function(data) {
                    callback.call(context || this, data);
                }
        ...
        addAram:function(contentData, callback, context) {
            var self = this;
            cloud.Ajax.request({
                url: "api/smart_alarm/add",
                type: "POST",
                data: contentData,
                success: function(data) {
        ...
        getModelByModelId:function(url,id,callback,context){
			var modelUrl = '';
			if(url =='api'){
