...
//            data.signalStrength = 1;
            ...
            if(data.metadata){
                this.element.find("#info-ssNumber").val(data.metadata.ssNumber);
            }else{
                this.element.find("#info-ssNumber").val("");
            }
...
//           this.locMarker && this.locMarker.setDraggable(false);
        ...
        submit: function(callback) {
            ...
            site.ssNumber= this.element.find("#info-ssNumber").val();
