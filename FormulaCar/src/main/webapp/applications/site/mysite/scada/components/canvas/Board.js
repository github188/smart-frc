...
//								cloud.images[img].src = "/FormulaCar/applications/site/mysite/scada/components/canvas/images/resource/"+imgsources[img].el+".png";
...
//							this.el.dom.style.cursor = 'move';
					...
					if(this.selectedLines &&  this.editable){
						...
						$("#canvas-edit").addClass("canvas-edit");
						//var point=ev.target.getBoundingClientRect();
						$(".canvas-edit").css("left",this.selectedLines.line.p[0][1].x+point.left);
						$(".canvas-edit").css("top",this.selectedLines.line.p[0][1].y+point.top);
					    $(".canvas-edit").css("padding-right","151");
						$(".canvas-edit").css("padding-bottom","23");
						$("#canvas-edit").css("display","block");
					}
