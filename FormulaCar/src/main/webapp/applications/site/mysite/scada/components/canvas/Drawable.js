...
//		},
		...
		drawAnnotations:function(ctx2d){
			var RING_INNER_RADIUS=30;
			var r=this.displayScale ? parseInt((this.displayScale/100) * 65) : 65;
			var radius = r + RING_INNER_RADIUS;
			var fontsize = this.displayScale ? parseInt((this.displayScale/100) * 12) : 12;
			...
			for (var angle=0; angle <  Math.PI+(Math.PI/this.aliquots); angle +=Math.PI/this.aliquots) {
				...
				var x=this.x + Math.cos(angle) * (radius - 30);
				var y=this.y - Math.sin(angle) * (radius - 30);
	            ctx2d.beginPath();
		...
		drawValue:function(ctx2d){
			var x1=this.x-(this.displayScale ? parseInt((this.displayScale/100) * 40) : 40);
			var y1=this.y+(this.displayScale ? parseInt((this.displayScale/100) * 45) : 45);
			var x2=this.displayScale ? parseInt((this.displayScale/100) * 80) : 80;
			var y2=this.displayScale ? parseInt((this.displayScale/100) * 30) : 30;
			var x3=this.x+(this.displayScale ? parseInt((this.displayScale/100) * 40) : 40);
			var y3=this.y+(this.displayScale ? parseInt((this.displayScale/100) * 35) : 35);
			var y4=this.y+(this.displayScale ? parseInt((this.displayScale/100) * 65) : 65);
		...
		drawValues:function(ctx2d){
			...
			if(this.board.editable){
			 ...
			 var x = this.x-(this.displayScale ? parseInt((this.displayScale/100) * 7) : 7);
			 var y = this.y+(this.displayScale ? parseInt((this.displayScale/100) * 50) : 50);
		...
		drawImage: function(ctx2d, image,xx,yy)
		{
			...
			if(this.type == 'text' || this.type == '5' || this.type == '7'){
				return;
			}
