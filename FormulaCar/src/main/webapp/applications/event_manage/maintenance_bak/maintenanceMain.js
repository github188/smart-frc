 ...
 * @author Lee李杰
 * @time 2017-06-01
 * @description initialize when this page first loading
 */
define( function( require) {
	require( "cloud/base/cloud");
	require( "cloud/lib/plugin/jquery.dataTables");
	var Table = require( "../../template/tableTemplate");
	var html = require( "text!./maintenanceMain.html");
	...
	var operationMenu = Class.create( cloud.Component, {
		...
		renderContent: function() {
			var areaMan_Array = ["automat_maintenanceList"];
			if( this.statusMg) {
