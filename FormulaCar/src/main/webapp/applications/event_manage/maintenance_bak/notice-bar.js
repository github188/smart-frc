 ...
 * @author Lee李杰
 * @time 2017-06-01
 * @description the notice information about maintenance's event
 */
    ...
    var NoticeBar = Class.create(cloud.Component, {
        ...
        draw: function() {
            ...
            var $htmls = $(+"<div></div>" +
                ...
                "</td>" +
                "<td>" +
                "<select id='automat_event_type'  name='automat_event_type' style='width:120px;  height: 28px; '>" +
                "<option value='0'>" + locale.get({
                    lang: "all_event_type"
                }) + "</option>" +
                "<option value='6'>" + locale.get({
                    lang: "event_app_update"
                }) + "</option>" +
                "<option value='12'>" + locale.get({
                    lang: "firmware_version_upgrade"
                }) + "</option>" +
                "<option value='13'>" + locale.get({
                    lang: "vsi_upgrade"
                }) + "</option>" +
                "<option value='1'>" + locale.get({
                    lang: "gate_event"
                }) + "</option>" +
                "<option value='15'>" + locale.get({
                    lang: "restart_of_industrial_control"
                }) + "</option>" +
                "<option value='14'>" + locale.get({
                    lang: "replenishment_start"
                }) + "</option>" +
                "<option value='4'>" + locale.get({
                    lang: "replenishment_finish"
                }) + "</option>" +
                "<option value='5'>" + locale.get({
                ...
                "<option value='11'>" + locale.get({
                    lang: "sync_model_configuration"
                }) + "</option>" +
                "<option value='7'>" + locale.get({
                    lang: "sync_ad_file"
                }) + "</option>" +
                "<option value='8'>" + locale.get({
                    lang: "synchronous_lottery_allocation"
                }) + "</option>" +
                "<option value='10'>" + locale.get({
