...
public class AreaStatisticDay {
    ...
    public Map<String, String> filedsMap(){
      Map<String,String> filedsMap = new HashMap<String,String>();
      filedsMap.put("amountOnLine", "amountOnLine");
      filedsMap.put("sumOnLine", "sumOnLine");
      filedsMap.put("amountOutLine", "amountOutLine");
      filedsMap.put("sumOutLine", "sumOutLine");
      
      filedsMap.put("amount", "amount");
      filedsMap.put("sum", "sum");
      
      filedsMap.put("wechatAmount", "wechatAmount");
      filedsMap.put("alipayAmount", "alipayAmount");
      filedsMap.put("baifubaoAmount", "baifubaoAmount");
      filedsMap.put("alipaySoundWaveAmount", "alipaySoundWaveAmount");
      filedsMap.put("otherAmount", "sumOutLine");
      filedsMap.put("swingCardAmount", "swingCardAmount");
      filedsMap.put("oneCardsolutionAmount", "oneCardsolutionAmount");
      filedsMap.put("agriculturalBankAmount", "agriculturalBankAmount");
      filedsMap.put("posMachineAmount", "posMachineAmount");
      filedsMap.put("gameAmount", "gameAmount");
      filedsMap.put("otherPayStyleAmount", "otherPayStyleAmount");
      filedsMap.put("vipPayAmount", "vipPayAmount");
      filedsMap.put("bestPayAmount", "bestPayAmount");
      filedsMap.put("jdpayAmount", "jdpayAmount");
      filedsMap.put("wechatBarcodeAmount", "wechatBarcodeAmount");
      filedsMap.put("alipayBarcodeAmount", "alipayBarcodeAmount");
      filedsMap.put("unionpayAmount", "unionpayAmount");
      filedsMap.put("qrcodepayAmount", "qrcodepayAmount");
      filedsMap.put("icbcpayAmount", "icbcpayAmount");
      filedsMap.put("dragonAmount", "dragonAmount");
      filedsMap.put("onePurseAmount", "onePurseAmount");
      filedsMap.put("unionReversepayAmount", "unionReversepayAmount");
      
      filedsMap.put("unionReversepaySum", "unionReversepaySum");
      filedsMap.put("onePurseSum", "onePurseSum");
      filedsMap.put("dragonSum", "dragonSum");
      filedsMap.put("icbcpaySum", "icbcpaySum");
      filedsMap.put("qrcodepaySum", "qrcodepaySum");
      filedsMap.put("unionpaySum", "unionpaySum");
      filedsMap.put("wechatSum", "wechatSum");
      filedsMap.put("alipaySum", "alipaySum");
      filedsMap.put("baifubaoSum", "baifubaoSum");
      filedsMap.put("alipaySoundWaveSum", "alipaySoundWaveSum");
      filedsMap.put("otherSum", "otherSum");
      filedsMap.put("swingCardSum", "swingCardSum");
      filedsMap.put("oneCardsolutionSum", "oneCardsolutionSum");
      filedsMap.put("agriculturalBankSum", "agriculturalBankSum");
      filedsMap.put("posMachineSum", "posMachineSum");
      filedsMap.put("gameSum", "gameSum");
      filedsMap.put("otherPayStyleSum", "otherPayStyleSum");
      filedsMap.put("vipPaySum", "vipPaySum");
      filedsMap.put("bestPaySum", "bestPaySum");
      filedsMap.put("jdpaySum", "jdpaySum");
      filedsMap.put("wechatBarcodeSum", "wechatBarcodeSum");
      filedsMap.put("alipayBarcodeSum", "alipayBarcodeSum");
