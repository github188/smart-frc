...
public class TaskNotificationConsumer implements MessageListener, ChannelAwareMessageListener {
    ...
    private final static Logger logger = Logger.getLogger("TaskNotificationConsumer[v1.1.0]");
    //
...
//在此接收消息
        logger.info("RECV A message from TaskNotice MQ:" + (new String(message.getBody())));
